...
describe Mumukit::Inspection::I18n do
  ...
  def expectation(binding, inspection)
    Mumukit::Inspection::Expectation.parse(binding: binding, inspection: inspection)
  end
  ...
  context 'es locale' do
    ...
    describe 'v2 expectations' do
      ...
      it { expect(expectation('Mumukit', 'DeclaresClass:Inspection').translate).to eq('<strong>Mumukit</strong> debe declarar una clase <strong>Inspection</strong>') }
